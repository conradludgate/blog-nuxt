...
export const title = "Dynamic Stylesheets and Yew";
export const date = "2020-04-12";
export const tags = ["dev", "rust", "yew", "react", "front-end"];
export const desc = "I recently discovered a really cool front-end framework written in Rust called Yew.";
