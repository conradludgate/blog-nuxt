...
I gave my server a fresh installation, ran `minikube start --driver=ssh ...` and got a single node cluster running in a single morning<h tag="1"/>.
...
<h tag="1">I had some issues with debian initially. Ubuntu worked well in the end</h>
